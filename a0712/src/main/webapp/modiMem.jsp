...
<html>
	...
	<body>
		...
		<section>
			<form name="agree" method="get" action="modiMem.do">
				...
				<fieldset class="fieldset_class">
					...
					<dl id="modify_pw1_dl">
						...
						<dd>
							<input type="password" id="pw1" name="pw1" value="${member.pw}"/>
					...
					<dl id="modify_mail_dl">
						...
						<dd>
							<input type="text" id="mail_id" name="mail_id" value="${member.email}"  />
							<span>@</span>
							<input type="text" id="main_tail" name="mail_tail" value="gmain.com"  />
							<select>
					...
					<dl id="modify_address_dl">
						...
						<dd>
							${member.addr }
							<input type="text" id="postal" name="f_postal" value="12345"  />
							<span></span>
